...
| `* * *`  | user                                       | delete a property                | remove entries that I no longer need                                   |
| `* * *`  | user                                       | find a property by name          | locate details of properties without having to go through the entire list |
| `* *`    | user                                       | hide private contact details   | minimize chance of someone else seeing them by accident                |
| `*`      | user with many properties in the address book | sort properties by name           | locate a property easily                                                 |
...
2.  AddressBook shows a list of properties
3.  User requests to delete a specific property in the list
4.  AddressBook deletes the property
...
2.  Should be able to hold up to 1000 properties without a noticeable sluggishness in performance for typical usage.
