...
*  `edit 2 n/Betsy Crower t/` Edits the name of the 2nd property to be `Betsy Crower` and clears all existing tags.
...
* `find Betsy` followed by `delete 1` deletes the 1st property in the results of the `find` command.
