...
public class CommandTestUtil {
    ...
    public static final String VALID_PHONE_CARL = "111111111111111111111111111111";
    public static final String VALID_EMAIL_AMY = "amy@example.com";
    public static final String VALID_EMAIL_BOB = "bob@example.com";
    public static final String VALID_ADDRESS_AMY = "Block 312, Amy Street 1";
    public static final String VALID_ADDRESS_BOB = "Block 123, Bobby Street 3";
    public static final String VALID_SELLER_AMY = "Alex Bee";
    public static final String VALID_SELLER_BOB = "Bernice Choo";
    public static final String VALID_PRICE_AMY = "1000000";
    ...
    public static final String SELLER_DESC_AMY = " " + PREFIX_SELLER + VALID_SELLER_AMY;
    public static final String SELLER_DESC_BOB = " " + PREFIX_SELLER + VALID_SELLER_BOB;
    ...
    public static final String INVALID_PHONE_DESC_TOO_SHORT = " " + PREFIX_PHONE + "9"; // min phone length is 3
    public static final String INVALID_PHONE_DESC_TOO_LONG = " " + PREFIX_PHONE
            + "1111111111111111111111111111111"; // max phone length is 30
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_EMAIL + "bob!yahoo"; // missing '@' symbol
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_ADDRESS; // empty string not allowed for addresses
    public static final String INVALID_SELLER_DESC = " " + PREFIX_SELLER + "James&"; // '&' not allowed in seller
    ...
    public static final EditPropertyCommand.EditPropertyDescriptor DESC_AMY;
    public static final EditPropertyCommand.EditPropertyDescriptor DESC_BOB;

    static {
        DESC_AMY = new EditPropertyDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withSeller(VALID_SELLER_AMY).withPrice(VALID_PRICE_AMY).withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPropertyDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withSeller(VALID_SELLER_BOB).withPrice(VALID_PRICE_BOB)
     ...
     */
    public static void assertCommandSuccess(SimpleCommand command, Model actualModel,
    ...
    /**
     * Convenience wrapper to {@link #assertCommandSuccess(SimpleCommand, Model, CommandResult, Model)}
     * that takes a string {@code expectedMessage}.
     */
    public static void assertCommandSuccess(SimpleCommand command, Model actualModel, String expectedMessage,
                                            Model expectedModel) {
     ...
     */
    public static void assertCommandFailure(SimpleCommand command, Model actualModel, String expectedMessage) {
