...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_PROPERTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SELLER_DESC_BOB + PRICE_DESC_BOB
                + TAG_DESC_FRIEND, new AddPropertyCommand(expectedProperty));

        // multiple names - last name accepted
        assertParseSuccess(parser, PREAMBLE_PROPERTY + NAME_DESC_AMY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SELLER_DESC_BOB + PRICE_DESC_BOB
                + TAG_DESC_FRIEND, new AddPropertyCommand(expectedProperty));

        // multiple phones - last phone accepted
        assertParseSuccess(parser, PREAMBLE_PROPERTY + NAME_DESC_BOB + PHONE_DESC_AMY + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SELLER_DESC_BOB + PRICE_DESC_BOB
                + TAG_DESC_FRIEND, new AddPropertyCommand(expectedProperty));

        // multiple emails - last email accepted
        assertParseSuccess(parser, PREAMBLE_PROPERTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_AMY + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SELLER_DESC_BOB + PRICE_DESC_BOB
                + TAG_DESC_FRIEND, new AddPropertyCommand(expectedProperty));

        // multiple addresses - last address accepted
        assertParseSuccess(parser, PREAMBLE_PROPERTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_AMY
                + ADDRESS_DESC_BOB + SELLER_DESC_BOB + PRICE_DESC_BOB
                + TAG_DESC_FRIEND, new AddPropertyCommand(expectedProperty));

        // multiple sellers - last sellers accepted
        assertParseSuccess(parser, PREAMBLE_PROPERTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_PROPERTY + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, PREAMBLE_PROPERTY + VALID_NAME_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SELLER_DESC_BOB + PRICE_DESC_BOB, expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, PREAMBLE_PROPERTY + NAME_DESC_BOB + VALID_PHONE_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SELLER_DESC_BOB + PRICE_DESC_BOB, expectedMessage);

        // missing email prefix
        assertParseFailure(parser, PREAMBLE_PROPERTY + NAME_DESC_BOB + PHONE_DESC_BOB + VALID_EMAIL_BOB + ADDRESS_DESC_BOB
                + SELLER_DESC_BOB + PRICE_DESC_BOB, expectedMessage);

        // missing address prefix
        assertParseFailure(parser, PREAMBLE_PROPERTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + VALID_ADDRESS_BOB
                + SELLER_DESC_BOB + PRICE_DESC_BOB, expectedMessage);

        // missing seller prefix
        assertParseFailure(parser, PREAMBLE_PROPERTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
        ...
        assertParseFailure(parser, PREAMBLE_PROPERTY + VALID_NAME_BOB + VALID_PHONE_BOB + VALID_EMAIL_BOB + VALID_ADDRESS_BOB
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, PREAMBLE_PROPERTY + INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SELLER_DESC_BOB + PRICE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, PREAMBLE_PROPERTY + NAME_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SELLER_DESC_BOB + PRICE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, PREAMBLE_PROPERTY + NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB
                + SELLER_DESC_BOB + PRICE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Email.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, PREAMBLE_PROPERTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
        ...
        assertParseFailure(parser, PREAMBLE_PROPERTY + INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
