...
public class JsonAdaptedPropertyTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedProperty person = new JsonAdaptedProperty(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedProperty person = new JsonAdaptedProperty(VALID_NAME, null, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedProperty person = new JsonAdaptedProperty(VALID_NAME, VALID_PHONE, null, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedProperty person = new JsonAdaptedProperty(VALID_NAME, VALID_PHONE, VALID_EMAIL, null, VALID_TAGS);
