...
public class TypicalBuyers {
    ...
    public static final Buyer ALICE = new BuyerBuilder(seedu.address.testutil.TypicalPersons.ALICE)
            .withPrice("123000").build();
    public static final Buyer BENSON = new BuyerBuilder(seedu.address.testutil.TypicalPersons.BENSON)
            .withPrice("1231000").build();
    public static final Buyer CARL = new BuyerBuilder(seedu.address.testutil.TypicalPersons.CARL)
            .withPrice("678000").build();
    public static final Buyer DANIEL = new BuyerBuilder(seedu.address.testutil.TypicalPersons.DANIEL)
            .withPrice("102200").build();
    public static final Buyer ELLE = new BuyerBuilder(seedu.address.testutil.TypicalPersons.ELLE)
            .withPrice("999000").build();
    public static final Buyer FIONA = new BuyerBuilder(seedu.address.testutil.TypicalPersons.FIONA)
