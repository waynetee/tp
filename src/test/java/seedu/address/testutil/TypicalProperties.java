...
public class TypicalProperties {
    ...
    public static final Property AMY = new PropertyBuilder().withName(VALID_NAME_AMY).withSeller(VALID_SELLER_AMY)
            .withPrice(VALID_PRICE_AMY).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY)
            .withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final Property BOB = new PropertyBuilder().withName(VALID_NAME_BOB).withSeller(VALID_SELLER_BOB)
