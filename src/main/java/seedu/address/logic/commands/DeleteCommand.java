...
public class DeleteCommand extends Command {
    ...
    public static final String MESSAGE_DELETE_PERSON_SUCCESS = "Deleted Property: %1$s";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        model.deletePerson(propertyToDelete);
        return new CommandResult(String.format(MESSAGE_DELETE_PERSON_SUCCESS, propertyToDelete));
    }
