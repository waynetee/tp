    ...
    public static Property[] getSampleProperties() {
        return new Property[] {
            new Property(new Name("Geylang St 29"), new Address("Blk 30 Geylang Street 29, #06-40"),
                ...
                new Email("alexyeoh@example.com")), new Price("420000"),
                getTagSet("friends")),
