 ...
 * A property is considered unique by comparing using {@code Property#isSamePerson(Property)}. As such, adding and updating of
 * persons uses Property#isSamePerson(Property) for equality so as to ensure that the property being added or updated is
